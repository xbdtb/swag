...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/xbdtb/swag/testdata/global_override/types.Application":  "string",
		"github.com/xbdtb/swag/testdata/global_override/types.Application2": "github.com/xbdtb/swag/testdata/global_override/othertypes.Application",
		"github.com/xbdtb/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/xbdtb/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/xbdtb/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/xbdtb/swag/gen"))

	parser = New(SetPackagePrefix("github.com/xbdtb/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/xbdtb/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/xbdtb/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/xbdtb/swag/gen"))

	parser = New(SetPackagePrefix("github.com/xbdtb/swag/cmd,github.com/xbdtb/swag/gen"))
